...
import ChartWithSecondaryAxis from "../ChartWithSecondaryAxis.js";

import DualMarker from "../../Components/DualMarker.js";
import TripleMarker from "../../Components/TripleMarker.js";
import QuadMarker from "../../Components/QuadMarker.js";
    ...
    return (
      <>
        <div className="content">
          <Routes>
            {/* <Route path="/test" element={<ColumnChart/>}/>
            ...
            <Route path="/dual-marker" element={<DualMarker />} />

            <Route path="/triple-marker" element={<TripleMarker />} />

            <Route path="/quad-marker" element={<QuadMarker />} />
